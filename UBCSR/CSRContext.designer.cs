...
namespace UBCSR
{
    ...
    partial void OnIsReturnedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Reservation_GroupLINQ", Storage="_Reservation", ThisKey="ReservationId", OtherKey="Id", IsForeignKey=true, DeleteRule="CASCADE")]
		public Reservation Reservation
		{
			get
			{
